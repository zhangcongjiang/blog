...
!function (e) {
    ...
    var d = [], o = Object.keys, h = {}, c = {}, t = /^(no-?highlight|plain|text)$/i, l = /\blang(?:uage)?-([\w-]+)\b/i,
        r = /((^(<[^>]+>|\t|)+|(?:\n)))/gm, a = {
            case_insensitive: "cI",
            lexemes: "l",
            contains: "c",
    ...
    function m(e) {
        ...
        return function e(t, r) {
            for (var a = t.firstChild; a; a = a.nextSibling) 3 === a.nodeType ? r += a.nodeValue.length : 1 === a.nodeType && (n.push({
                ...
                offset: r,
                node: a
            }), r = e(a, r), b(a).match(/br|hr|img|input/) || n.push({event: "stop", offset: r, node: a}));
            return r
        }(e, 0), n
    }
    ...
    function k(e, t, i, r) {
        ...
        function s() {
            b += null != u.sL ? function () {
                ...
                var e, t, r, a, n, i, s;
                if (!u.k) return y(p);
                for (a = "", t = 0, u.lR.lastIndex = 0, r = u.lR.exec(p); r;) a += y(p.substring(t, r.index)), n = u, i = r, void 0, s = l.cI ? i[0].toLowerCase() : i[0], (e = n.k.hasOwnProperty(s) && n.k[s]) ? (m += e[1], a += c(e[0], y(r[0]))) : a += y(r[0]), t = u.lR.lastIndex, r = u.lR.exec(p);
        ...
        function a(e, t) {
            ...
            if (r) return r.skip ? p += t : (r.eB && (p += t), s(), r.rB || r.eB || (p = t)), o(r), r.rB ? 0 : t.length;
            ...
            if (a) {
                var n = u;
                for (n.skip ? p += t : (n.rE || n.eE || (p += t), s(), n.eE && (p = t)); u.cN && (b += N), u.skip || u.sL || (m += u.r), (u = u.parent) !== a.parent;) ;
                return a.starts && (a.endSameAsBegin && (a.starts.eR = a.eR), o(a.starts)), n.rE ? 0 : t.length
            }
            if (function (e, t) {
                return !i && w(t.iR, e)
            }(t, u)) throw new Error('Illegal lexeme "' + t + '" for mode "' + (u.cN || "<unnamed>") + '"');
        ...
        var p = "", m = 0;
        try {
            for (var f, g, _ = 0; u.t.lastIndex = _, f = u.t.exec(t);) g = a(t.substring(_, f.index), f[0]), _ = f.index + g;
    ...
    function x(r, e) {
        ...
        return e.filter(M).filter(_).forEach(function (e) {
            var t = k(e, r, !1);
    ...
    function s(e) {
        var t, r, a, n, i, s = function (e) {
            ...
            if (i += e.parentNode ? e.parentNode.className : "", r = l.exec(i)) return M(r[1]) ? r[1] : "no-highlight";
            for (t = 0, a = (i = i.split(/\s+/)).length; t < a; t++) if (u(n = i[t]) || M(n)) return n
        }(e);
        u(s) || (v.useBR ? (t = document.createElementNS("http://www.w3.org/1999/xhtml", "div")).innerHTML = e.innerHTML.replace(/\n/g, "").replace(/<br[ \/]*>/g, "\n") : t = e, i = t.textContent, a = s ? k(s, i, !0) : x(i), (r = m(t)).length && ((n = document.createElementNS("http://www.w3.org/1999/xhtml", "div")).innerHTML = a.value, a.value = function (e, t, r) {
            var a = 0, n = "", i = [];
            ...
            function c(e) {
                n += "<" + b(e) + d.map.call(e.attributes, function (e) {
        ...
        }(r, m(n), i)), a.value = f(a.value), e.innerHTML = a.value, e.className = function (e, t, r) {
    ...
    return n.highlight = k, n.highlightAuto = x, n.fixMarkup = f, n.highlightBlock = s, n.configure = function (e) {
        v = p(v, e)
    }, n.initHighlighting = g, n.initHighlightingOnLoad = function () {
        ...
        return o(h)
    }, n.getLanguage = M, n.autoDetection = _, n.inherit = p, n.IR = n.IDENT_RE = "[a-zA-Z]\\w*", n.UIR = n.UNDERSCORE_IDENT_RE = "[a-zA-Z_]\\w*", n.NR = n.NUMBER_RE = "\\b\\d+(\\.\\d+)?", n.CNR = n.C_NUMBER_RE = "(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)", n.BNR = n.BINARY_NUMBER_RE = "\\b(0b[01]+)", n.RSR = n.RE_STARTERS_RE = "!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~", n.BE = n.BACKSLASH_ESCAPE = {
        b: "\\\\[\\s\\S]",
        r: 0
        ...
        i: "\\n",
        c: [n.BE]
    }, n.PWM = n.PHRASAL_WORDS_MODE = {b: /\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\b/}, n.C = n.COMMENT = function (e, t, r) {
        ...
        return {
            ...
            c: c.concat([n, {
                ...
                c: [{b: i, rB: !0, c: [e.TM], r: 0}, {
                    ...
                    k: s,
                    r: 0,
                    c: [e.CLCM, e.CBCM, r, a, t, {b: /\(/, e: /\)/, k: s, r: 0, c: ["self", e.CLCM, e.CBCM, r, a, t]}]
                }, e.CLCM, e.CBCM, n]
        ...
        return {
            ...
            c: [e.C(";", "$"), e.HCM, {cN: "section", b: /^\s*\[+/, e: /\]+/}, {
                ...
                c: [{cN: "attr", b: /[a-z0-9\[\]_\.-]+/}, {
                    ...
                    eW: !0,
                    r: 0,
                    c: [e.C(";", "$"), e.HCM, {cN: "literal", b: /\bon|off|true|false|yes|no\b/}, {
                        cN: "variable",
                        v: [{b: /\$[\w\d"][\w\d_]*/}, {b: /\$\{(.*?)}/}]
        ...
        var t = {
                ...
                v: [{b: /(u|b)?r?'''/, e: /'''/, c: [e.BE, r], r: 10}, {
                    ...
                    b: /(b|br)"/,
                    e: /"/
                }, {b: /(fr|rf|f)'/, e: /'/, c: [e.BE, a]}, {b: /(fr|rf|f)"/, e: /"/, c: [e.BE, a]}, e.ASM, e.QSM]
