!function (b) {
    ...
    d.prototype = {
        ...
        var j = e(this), i = j.attr("href"), h = e(j.attr("data-target") || i && i.replace(/.*(?=#[^\s]+$)/, "")),
            g = h.data("modal") ? "toggle" : e.extend({remote: !/#/.test(i) && i}, h.data(), j.data());
...
(function (a) {
    Date.now = Date.now || function () {
        ...
        var G = a.extend({}, a.ias.defaults, A), C = new a.ias.util, J = new a.ias.paging(G.scrollContainer),
            B = G.history ? new a.ias.history : !1, F = this;
        x()
    }, a.ias.defaults = {
        container: "#container",
    ...
    a(document).ready(function () {
        ...
        window._bd_share_config = {
            common: {
                ...
                "bdStyle": "0",
                "bdSize": "24"
            }, share: [{bdCustomStyle: "/wp-content/themes/Yusi/share.css"}],
        };
                ...
                a(window).scroll(function () {
                    ...
                    if (x > v.eq(i - 1).offset().top + v.eq(i - 1).height()) {
                        if (a(".widgetRoller").length == 0) {
                            ...
                            a(".widgetRoller").css({position: "fixed", top: 10, zIndex: 0, width: 360})
                        } else {
        ...
        a.fn.postLike = function () {
            if (a(this).hasClass("actived")) {
                ...
                var w = {action: "bigfa_like", um_id: z, um_action: y};
                a.post("/love/", w, function (A) {
                    a(x).html(A)
                });
                a.tipsBox({
        ...
        var m = "0", f = '<div class="comt-tip comt-loading">正在提交, 请稍候...</div>',
            c = '<div class="comt-tip comt-error">#</div>', b = '">提交成功', d = "取消编辑", o, k = 1, r = [];
        r.push("");
        ...
        addComment = {
            moveForm: function (z, A, E, y, B) {
                var I = this, w, D = I.I(z), x = I.I(E), H = I.I("cancel-comment-reply-link"),
                    F = I.I("comment_parent"), G = I.I("comment_post_ID");
                if (o) {
                    p()
                }
